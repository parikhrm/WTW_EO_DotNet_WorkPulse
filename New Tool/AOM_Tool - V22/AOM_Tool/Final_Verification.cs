    ...
    public partial class Final_Verification : Form
    {
        ...
        public void productivity_calculate_filter()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "aom.usp_productivity_calculate_filter_dotnet_final_verification_new_V1";
                cmd.Parameters.AddWithValue("@associatename", searchby_empname.Text);
                cmd.Parameters.AddWithValue("@date", searchby_date.Value.Date);
                cmd.Parameters.AddWithValue("@teamnameid",searchby_teamname.SelectedValue);
                sda.SelectCommand = cmd;
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("http://mum1-cb-dbse01p/Reports/report/DRD%20MI%20Mumbai/DRD%20Reports/rpt_SSRS_TimeTracker_LogIn_LogOut_Data_DotNet");
            }
            catch (Exception ab)
            {
        ...
        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("http://mum1-cb-dbse01p/Reports/report/DRD%20MI%20Mumbai/DRD%20Reports/rpt_SSRS_WorkPulse_Verified_Status_Report_DotNet");
            }
            catch (Exception ab)
            {
                MessageBox.Show("Unable to open link that was clicked. Following are the error generated details" + ab.ToString());
