    ...
    class TeamDetails
    {
        ...
        public void teamname_associatewise_list(DataTable dta, string intid)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select distinct TeamName,IsCore from aom.vw_teamdetails_dotnet where intid = @intid and TeamNameID not in (2,3,6,9) order by IsCore desc,TeamName";
                cmd.Parameters.AddWithValue("@intid",intid);
                sda.SelectCommand = cmd;
                dt = dta;
                sda.Fill(dta);
        ...
        public void teamname_associatewise_rtm_verification_list(DataTable dta, string intid)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "select distinct TeamName,TeamNameID from aom.vw_teamdetails_dotnet where EmpName = @intid and TeamNameID not in (2,3,6,9) order by TeamName";
                cmd.Parameters.AddWithValue("@intid", intid);
                sda.SelectCommand = cmd;
                dt = dta;
                sda.Fill(dta);
        ...
        public void coreteamname_associatewise_list(DataTable dta, string intid)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "select distinct CoreTeamName,TeamNameID,IsCore from aom.vw_teamdetails_dotnet where intid = @intid and TeamNameID not in (2,3,6,9) order by IsCore desc";
                cmd.Parameters.AddWithValue("@intid", intid);
                sda.SelectCommand = cmd;
                dt = dta;
                sda.Fill(dta);
        ...
        public void teamname_list(DataTable dta)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Clear();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "select distinct TeamName,TeamNameID from aom.vw_teamdetails_dotnet where TeamNameID not in (2,3,6,9) order by TeamName asc";
                sda.SelectCommand = cmd;
                dt = dta;
                sda.Fill(dta);
            }
        ...
        public void teamname_list_amend_teamdetails_form(DataTable dta)
        {
            //string connectionstringtxt = "Data Source=MUM1-CB-DBSE01P;Initial Catalog=DRD;User ID=DRDUsers;Password=24252425";
            string connectionstringtxt = "Data Source=A20-CB-DBSE01P;Initial Catalog=DRD;User ID=DRDUsers;Password=24252425";
            //string connectionstringtxt = System.Configuration.ConfigurationManager.ConnectionStrings["connection_string"].ConnectionString;
